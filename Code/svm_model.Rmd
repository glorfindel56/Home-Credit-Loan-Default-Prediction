...
data <-read_csv(file = "/Users/joycehu/Library/CloudStorage/Box-Box/MGT 6203/application_imputed_cleaner_v3.csv", col_names = TRUE)
...
svm_model <- function(method_input, metric_input) {
# Define your k-fold cross-validation control
control <- trainControl(method = "cv", number = 10, classProbs = TRUE)
# metric <- "Accuracy"
model <- train(as.factor(target) ~ ., data = train_valid_data, method = method_input, 
...
svm_1 <- svm_model(method_input = "svmRadial", metric_input = "Accuracy")

# have to re-clean dataset...
